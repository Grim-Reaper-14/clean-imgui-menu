...
bool ImGui::TabButtonEx(const char* ico, ImTextureID icon_texture, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, bool selected)
{
    ...
    ImGui::ShadeVertsLinearColorGradientKeepAlpha(GetWindowDrawList(), vtx_idx_1, vtx_idx_2, bb.Min + ImVec2(20, 0), bb.Max + ImVec2(bb.Min.x - bb.Min.x - 20, 20), ImColor(it_nameanim->second * 2, 0.40f, 0.40f, 1.00f), ImColor(0.05f, 0.05f, 0.05f, 1.00f)); // ãðàäèåíò
