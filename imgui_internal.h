...
//#endif
    ...
    IMGUI_API bool          TabButtonEx(const char* ico, ImTextureID icon_texture, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool selected = false);
