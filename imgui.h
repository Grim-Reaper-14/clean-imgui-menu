...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButton(const char* ico, const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false);   // button
    IMGUI_API bool          TabButtonImage(ImTextureID icon_texture, const char* fallback_ico, const char* label, const ImVec2& size = ImVec2(0, 0), bool selected = false); // image-backed tab button with glyph fallback
