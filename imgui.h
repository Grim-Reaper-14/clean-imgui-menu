...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButtonImage(ImTextureID icon_texture, const char* fallback_ico, const char* label, const ImVec2& size = ImVec2(0, 0)); // image-backed tab button with glyph fallback
